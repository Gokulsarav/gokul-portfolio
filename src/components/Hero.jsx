...
const Hero = () => {
    ...
    const socialIcons = [
        { icon: <FaGithub size={22} />, link: personalInfo.socialLinks.github, label: 'GitHub' },
        { icon: <FaLinkedinIn size={22} />, link: personalInfo.socialLinks.linkedin, label: 'LinkedIn' },
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-40 -left-40 w-80 h-80 bg-accent-400/20 dark:bg-accent-600/10 rounded-full blur-3xl animate-blob" style={{ animationDelay: '2s' }} />
                <div className="absolute -bottom-40 left-1/2 w-80 h-80 bg-primary-300/20 dark:bg-primary-700/10 rounded-full blur-3xl animate-blob" style={{ animationDelay: '4s' }} />
            </div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                ...
                <motion.div
                    ...
                    className="text-xl sm:text-2xl md:text-3xl text-dark-500 dark:text-dark-400 font-light mb-6 h-10"
                >
                ...
                >
                    ...
                    <a href={resumePdf} download="Gokul-S-CV.pdf" className="btn-outline flex items-center gap-2">
                        <HiDownload />
                        Download CV
                    </a>
                </motion.div>
